...
GW_VER=`curl http://kingpin/api/docker/environment/qa-21/artifact/groundwork-web | python -c "import sys, json; print json.load(sys.stdin)[0]['image']" | egrep -o '[[:digit:]].[[:digit:]].[[:digit:]]{3}$'`
